...
void NNSC(unsigned char* R, unsigned char* G, unsigned char* B, int nRows, int nCols, 
          int superpixelnum, float ratio, int* label, int Kpm, int patch_w, int iterationNum)
{
    //LSC features parameters
    ...
    DoSuperpixel(L1,L2,a1,a2,b1,b2,x1,x2,y1,y2,W,label,seedArray,newSeedNum,nRows,nCols,StepX,StepY,iterationNum,
            thresholdCoef, R, G, B, Kpm, patch_w);
